...
module.exports = function(input){
    ...
    var errors = {
      source:{
        has: function(pattern){
          return compose(pattern, "was expected in the source Markdown, but wasn't found.")
        },
        no: function(pattern){
          return compose(pattern, "was found in the source Markdown, but wasn't expected.")
        }
      },
      rendered:{
        has: function(pattern){
          return compose(pattern, "was expected the rendered HTML, but wasn't found.")
        },
        no: function(pattern){
          return compose(pattern, "was found in the rendered HTML, but wasn't expected.")
        }
      },
      copy:{
        has: function(pattern){
          return compose(pattern, "was expected in the copy, but wasn't found.")
        },
        no: function(pattern){
          return compose(pattern, "was found in the copy, but wasn't expected.")
        }
      },
      code:{
        has: function(pattern){
          return compose(pattern, "was expected in the code, but wasn't found.")
        },
        no: function(pattern){
          return compose(pattern, "was found in the code, but wasn't expected.")
        }
      },
      markup:{
        has: function(pattern){
          return compose(pattern, "was expected in the markup structure, but wasn't found.")
        },
        no: function(pattern){
          return compose(pattern, "was found in the markup structure, but wasn't expected.")
        }
      }
    }
    ...
    var methods = {
        ...
        rendered: {
           has: function(pattern){
             handle("rendered", true, pattern, rendered, errors.rendered.has(pattern))
           },
           no: function(pattern){
             handle("rendered", false, pattern, rendered, errors.rendered.no(pattern))
           }
       },
       copy: {
           has: function(pattern){
